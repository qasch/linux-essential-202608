...
- Schicke den `sleep` Prozess nun erneut in den Hintergrund und starte einen weiteren Prozess mit `sleep 400`. Schicke auch diesen in den Hintergrund. Nun befinden sich zwei Prozesse im Hintergrund.
