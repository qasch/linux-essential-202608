...
## Übung 16: IP Adresse extrahieren

Ihr wollt die IP-Adresse eures Systems ermitteln. Die Ausgabe von `ip a` liefert euch zusätzlich aber noch weitere Informationen.

Versucht mit Hilfe der euch bekannten Filterkommandos ausschliesslich die IP Adresse eures Systems aus dieser Anzeige zu extrahieren.

Achtet dabei darauf, dass das Kommando welches ihr erstellt möglichst *generische* ist, also auf möglichst vielen Systemen funktioniert, unabhängig vom Netz in dem ihr euch befindet, ob ihr euch im LAN oder WLAN befindet usw.

Erstellt daraus letztlich einen Alias.
